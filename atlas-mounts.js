...
(function () {
  ...
  var MOUNTS = {
    maintenance: {
      ...
      src: "mounts/RISE-Weekly-Maintenance-Report.html",
      background: "#F4F7F9",
      icon: "ph-wrench"
    },
    marketing: {
      ...
      src: "mounts/RISE-Marketing-Command-Center.html",
      background: "#F0F4F6",
      icon: "ph-megaphone"
    },
    budget: {
      ...
      src: "mounts/RISE-Budget-Builder.html",
      background: "#F1F4F6",
      icon: "ph-calculator"
    },
    people: {
      ...
      src: "mounts/RISE-Performance-Platform.html",
      background: "#F3F6F8",
      icon: "ph-trophy"
    }
  };
