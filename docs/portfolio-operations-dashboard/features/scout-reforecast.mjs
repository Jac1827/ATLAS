...
export async function readScoutReforecast(central,{communityId,period,cache=createActiveReforecastCache(central)}={}){
 ...
 return {...evidence,originalBudget:month.originalBudget,actuals:month.actuals,closed:month.closed,closeVersionId:month.closeVersionId||null,publishedFingerprint:publication.snapshot.fingerprint,publishedBy:publication.publishedBy,sourceVersion:publication.source?.sourceVersion};
}
