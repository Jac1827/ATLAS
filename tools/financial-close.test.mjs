...
let calls=0;const cache=createCache({readCommunitiesForAccess:async()=>[{community_id:'id',display_name:'Community',canonical_name:'community'}],rpc:async()=>{calls++;return versions.map(v=>({community_id:'id',period_key:v.period_key,summary:{registryVersion:'atlas-finance-v1',communityId:'id',period:v.period_key,close:v}}));}});
