...
const projected=B.project([{batchId:'x',validationStatus:'valid',sourceAsOf:'2026-09-16',records:[{applicationId:'1',atlasName:'A',communityId:'A',mappingStatus:'mapped',applicationApprovedOn:'2026-09-14',leaseSignedOn:'2026-09-15',moveInDate:'2026-09-25'}]}],['A']);
assert.equal(projected.records[0].applicationApproved,'2026-09-14');assert.equal(projected.records[0].leaseSigned,'2026-09-15');assert.equal(projected.records[0].moveIn,'');
