...
try{
 ...
 else {const book=XLSX.utils.book_new(),sheet=XLSX.utils.aoa_to_sheet([['GL','Account','Sep 2026','Oct 2026'],['5120','Rent',0,123],['6330','Expense',10,-1]]);sheet.D2={t:'n',v:123,f:'C2+123'};XLSX.utils.book_append_sheet(book,sheet,'Input');bytes=Buffer.from(XLSX.write(book,{bookType:'xlsx',type:'buffer'}));const evidence=await parseReforecastWorkbook(bytes,{xlsx:XLSX,fileName:'fixture.xlsx'});result={evidence,audit:evidence.integrity};}
