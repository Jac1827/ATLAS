...
export async function installProjectionFixture(db){
 ...
 for(const name of ['20260924232845_bounded_workbook_audit_transport.sql','20260925011545_workbook_audit_validation_performance.sql','20260925032350_workbook_raw_json_canonical.sql','20260925033844_workbook_raw_evidence_projections.sql','20260925032731_workbook_activate_raw_evidence_projection.sql'])await db.exec(fs.readFileSync(new URL('../supabase/migrations/'+name,import.meta.url),'utf8'));
}
